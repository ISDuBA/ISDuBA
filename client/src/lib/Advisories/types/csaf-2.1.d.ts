 ...
 * @minItems 1
 */
export type ListOfActions = [Action, ...Action[]];
/**
 * Contains a list of entities that act.
 *
 * @minItems 1
 */
export type ListOfActingEntities = [
  ReferenceTokenForEntityGroupInstance | ReferenceTokenForEntityInstance,
  ...(ReferenceTokenForEntityGroupInstance | ReferenceTokenForEntityInstance)[]
];
/**
 ...
 */
export type ReferenceTokenForEntityGroupInstance = string;
/**
 ...
 */
export type ReferenceTokenForEntityInstance = string;
/**
 ...
 */
export type DateOfTheAction = string;
/**
 * Contains a list of local IDs referring to vulnerabilities within the same document that this action applies to.
 *
 * @minItems 1
 */
export type ListOfDocumentLocalVulnIDs = [
  DocumentLocalReferenceTokenForVulnerabilityInstance,
  ...DocumentLocalReferenceTokenForVulnerabilityInstance[]
];
/**
 ...
 */
export type DocumentLocalReferenceTokenForVulnerabilityInstance = string;
/**
 ...
 * @minItems 1
 */
export type ListOfReceivingEntities = [
  ReferenceTokenForEntityGroupInstance | ReferenceTokenForEntityInstance,
  ...(ReferenceTokenForEntityGroupInstance | ReferenceTokenForEntityInstance)[]
];
/**
 ...
 * @minItems 1
 */
export type ListOfReferencedActions = [ReferenceTokenForActionInstance, ...ReferenceTokenForActionInstance[]];
/**
 ...
 */
export type ReferenceTokenForActionInstance = string;
/**
 * Contains information about the action.
 */
export type SummaryOfTheAction = string;
/**
 * Contains an observation about the action.
 */
export type ActionStatus =
  "attempted" | "completed" | "deferred" | "discontinued" | "in_progress" | "outstanding" | "planned";
/**
 * Contains a list of entities related.
 *
 * @minItems 1
 */
export type ListOfEntities = [Entity, ...Entity[]];
/**
 ...
 */
export type PublicOpenPGPKeyURL = string;
/**
 ...
 * Contains a token required to identify an entity uniquely in the context of the current document so that it can be referred to from other parts in the document.
 */
export type ReferenceTokenForEntityInstance1 = string;
/**
 * Contains the name of the entity.
 */
export type NameOfTheEntity = string;
/**
 * Contains a list of entity groups.
 *
 * @minItems 1
 */
export type ListOfEntityGroups = [EntityGroup, ...EntityGroup[]];
/**
 * Contains a token required to identify a group of entities uniquely in the context of the current document so that it can be referred to from other parts in the document.
 */
export type ReferenceTokenForEntityGroupInstance1 = string;
/**
...
export type ListOfEntityIDs = [
  ReferenceTokenForEntityInstance,
  ReferenceTokenForEntityInstance,
  ...ReferenceTokenForEntityInstance[]
];
/**
 ...
 */
export type NameOfTheEntityGroup = string;
/**
 * Contains a human-readable summary stating the purpose of the group.
 */
export type SummaryOfTheEntityGroup = string;
/**
 ...
 */
export type ExtensionCategory = "essential" | "significant" | "supplementary";
/**
 ...
 * Contains a token required to identify a vulnerability uniquely in the context of the current document so that it can be referred to from other parts in the document.
 */
export type DocumentLocalReferenceTokenForVulnerabilityInstance1 = string;
/**
...
export interface Involvement {
  ...
  entity_groups?: ListOfEntityGroups;
}
/**
 * Contains details about a single event in the timeline.
 */
export interface Action {
  acting_entity_refs: ListOfActingEntities;
  action_id: ActionID;
  category: ActionCategory;
  date: DateOfTheAction;
  dl_vuln_ids?: ListOfDocumentLocalVulnIDs;
  group_ids?: ListOfProductGroupIds;
  product_ids?: ListOfProductIds;
  receiving_entity_refs?: ListOfReceivingEntities;
  referenced_action_ids?: ListOfReferencedActions;
  summary?: SummaryOfTheAction;
  status: ActionStatus;
}
/**
...
export interface Entity {
  ...
  contact?: ContactOfTheEntity;
  entity_id: ReferenceTokenForEntityInstance1;
  name?: NameOfTheEntity;
}
/**
 * Contains information on how to contact the entity.
 */
export interface ContactOfTheEntity {
  details?: ContactDetails;
  email?: Email;
  public_openpgp_key_url?: PublicOpenPGPKeyURL;
  url?: ContactURL;
}
/**
...
export interface EntityGroup {
  entity_group_id: ReferenceTokenForEntityGroupInstance1;
  entity_ids: ListOfEntityIDs;
  name: NameOfTheEntityGroup;
  summary?: SummaryOfTheEntityGroup;
}
/**
...
export interface Vulnerability {
  ...
  dl_vuln_id?: DocumentLocalReferenceTokenForVulnerabilityInstance1;
