...
sudo -u postgres "host    all             all             192.168.56.1/32         scram-sha-256" >>/etc/postgresql/16/main/pg_hba.conf
sudo -u postgres "host    all             all             127.0.0.1/32            scram-sha-256" >>/etc/postgresql/16/main/pg_hba.conf
