...
This repo contains an example docker compose setup. All components are configured
for ease of setup, it is recommended to use the productionsetup for production usage.
